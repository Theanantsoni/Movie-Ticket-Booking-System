...
// Check if the session data for OTP verification exists
if (!isset($_SESSION['otp']) || !isset($_SESSION['otp_expiry'])) {
    // Redirect to a page or show an error if OTP session data is not set
...
if (isset($_POST['verifyOtp'])) {
    ...
    if (empty($otp)) {
        ...
        // Unset OTP session data to prevent reuse
        unset($_SESSION['otp']);
